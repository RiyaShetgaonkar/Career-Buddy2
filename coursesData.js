...
{
  title: "C Programming for Applications",
  skills: ["c", "logic building"],
  degree: ["BCA"],
  branch: ["Computer Applications"],
  cgpaMin: 5,
  platform: "NPTEL",
...
},
{
  ...
  skills: ["fluid mechanics", "hydraulics"],
  degree: ["BE"],
  branch: ["Mechanical Engineering"],
  cgpaMin: 6,
  platform: "NPTEL",
...
},
{
  ...
  skills: ["investment banking", "valuation", "finance"],
  degree: ["BBA"],
  branch: ["Finance"],
  cgpaMin: 6,
  platform: "Udemy",
...
},
{
  ...
  skills: ["corporate finance", "risk management"],
  degree: ["BBA"],
  branch: ["Finance"],
  cgpaMin: 6,
  platform: "Coursera",
...
},
{
  ...
  skills: ["stock market", "trading", "investments"],
  degree: ["BBA"],
  branch: ["Finance"],
  cgpaMin: 5,
  platform: "Coursera",
...
},
{
  ...
  skills: ["social media", "instagram marketing"],
  degree: ["BBA"],
  branch: ["Marketing"],
  cgpaMin: 0,
  platform: "Udemy",
...
},
{
  ...
  skills: ["performance management", "appraisal"],
  degree: ["BBA"],
  branch: ["HR"],
  cgpaMin: 5,
  platform: "Coursera",
...
{
  title: "HR Analytics",
  skills: ["hr analytics", "data analysis"],
  degree: ["BBA"],
  branch: ["HR"],
  cgpaMin: 6,
  platform: "Coursera",
